...
public class StripeCheckout extends SetUPClass {
	...
	public void click_on_signup_button() throws Throwable {
		/*
		 * Thread.sleep(4000); try { WebElement Sign_Up = driver.findElement(By.
	...
	public void verify_the_checkout_process_via_stripe() throws Throwable {
		/*
		 * try { Thread.sleep(1000); WebElement option1 = wait
		 * .until(ExpectedConditions.elementToBeClickable(By.xpath(
		 * "//input[@id='amasty_stripe']"))); option1.click();
		 * 
		 ...
		 * place_order_btn); place_order_btn.click(); Thread.sleep(2000); } catch
	...
	public void delete_the_account() throws Throwable {
		 ...
		 * .until(ExpectedConditions.elementToBeClickable(By.
		 * xpath("//a[normalize-space()='Delete Account']"))); Thread.sleep(2000);
